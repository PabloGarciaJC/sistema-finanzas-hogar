...
class MonthlySummaryFixture extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $conn->executeStatement("
            ...
            (2, 1, 11, 5000.00, 500.00, 2000.00, 1000.00, 500.00),
            (2, 2, 11, 5200.00, 600.00, 1800.00, 800.00, 400.00),
            (2, 1, 11, 4500.00, 400.00, 1500.00, 700.00, 300.00),
            (2, 2, 11, 4700.00, 450.00, 1600.00, 750.00, 350.00)
        ");
    }
