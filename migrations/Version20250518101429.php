...
final class Version20250518101429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE monthly_summary ADD CONSTRAINT FK_MONTHLY_SUMMARY_MEMBER FOREIGN KEY (member_id) REFERENCES member (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE monthly_summary DROP FOREIGN KEY FK_MONTHLY_SUMMARY_MEMBER');
